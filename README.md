...
- [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) ([v2.22.0](https://github.com/ToolJet/ToolJet/releases/tag/v2.22.0), 5 days ago) - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
- [argilla-io/argilla](https://github.com/argilla-io/argilla) ([v1.17.0](https://github.com/argilla-io/argilla/releases/tag/v1.17.0), 5 days ago) - ✨Argilla: the open-source feedback platform for LLMs
