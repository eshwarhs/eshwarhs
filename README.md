...
- [argilla-io/argilla](https://github.com/argilla-io/argilla) - ✨Argilla: the open-source data curation platform for LLMs (5 days ago)
- [eshwarhs/eshwarhs.github.io](https://github.com/eshwarhs/eshwarhs.github.io) - My Portfolio Website (6 days ago)
- [eshwarhs/CMovies](https://github.com/eshwarhs/CMovies) -  (3 weeks ago)
...
- [argilla-io/argilla](https://github.com/argilla-io/argilla) ([v1.15.1](https://github.com/argilla-io/argilla/releases/tag/v1.15.1), 3 days ago) - ✨Argilla: the open-source data curation platform for LLMs
- [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) ([v2.16.1](https://github.com/ToolJet/ToolJet/releases/tag/v2.16.1), 3 days ago) - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀

#### 🔨 Latest Pull Requests I published

- [feat: add `workspace add-user` command](https://github.com/argilla-io/argilla/pull/3712) on [argilla-io/argilla](https://github.com/argilla-io/argilla) (6 days ago)
- [feat/cli : add `python -m argilla workspaces create` command](https://github.com/argilla-io/argilla/pull/3676) on [argilla-io/argilla](https://github.com/argilla-io/argilla) (1 week ago)
