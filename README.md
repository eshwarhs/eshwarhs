...
- [argilla-io/argilla](https://github.com/argilla-io/argilla) ([v2.0.0rc2](https://github.com/argilla-io/argilla/releases/tag/v2.0.0rc2), 3 days ago) - Argilla is a collaboration platform for AI engineers and domain experts that require high-quality outputs, full data ownership, and overall efficiency.
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.9.18](https://github.com/argoproj/argo-cd/releases/tag/v2.9.18), 6 days ago) - Declarative Continuous Deployment for Kubernetes
