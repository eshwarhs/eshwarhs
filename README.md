...
- [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) ([v2.15.1](https://github.com/ToolJet/ToolJet/releases/tag/v2.15.1), 3 days ago) - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
- [argilla-io/argilla](https://github.com/argilla-io/argilla) ([v1.15.0](https://github.com/argilla-io/argilla/releases/tag/v1.15.0), 3 days ago) - ✨Argilla: the open-source data curation platform for LLMs

#### 🔨 Latest Pull Requests I published

- [feat/cli : add `python -m argilla workspaces create` command](https://github.com/argilla-io/argilla/pull/3676) on [argilla-io/argilla](https://github.com/argilla-io/argilla) (4 days ago)
