...
- [argilla-io/argilla](https://github.com/argilla-io/argilla) ([v1.15.1](https://github.com/argilla-io/argilla/releases/tag/v1.15.1), 2 days ago) - ✨Argilla: the open-source data curation platform for LLMs
- [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) ([v2.16.1](https://github.com/ToolJet/ToolJet/releases/tag/v2.16.1), 2 days ago) - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀

#### 🔨 Latest Pull Requests I published

- [feat: add `workspace add-user` command](https://github.com/argilla-io/argilla/pull/3712) on [argilla-io/argilla](https://github.com/argilla-io/argilla) (5 days ago)
