...
- [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) ([v2.14.0](https://github.com/ToolJet/ToolJet/releases/tag/v2.14.0), 3 days ago) - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀

#### 🔨 Latest Pull Requests I published

- [feat: Add ```logout``` command](https://github.com/argilla-io/argilla/pull/3605) on [argilla-io/argilla](https://github.com/argilla-io/argilla) (3 days ago)
