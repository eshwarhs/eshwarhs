...
- [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) ([v2.35.0](https://github.com/ToolJet/ToolJet/releases/tag/v2.35.0), 2 days ago) - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.11.0-rc1](https://github.com/argoproj/argo-cd/releases/tag/v2.11.0-rc1), 5 days ago) - Declarative Continuous Deployment for Kubernetes
- [argilla-io/argilla](https://github.com/argilla-io/argilla) ([v1.26.1](https://github.com/argilla-io/argilla/releases/tag/v1.26.1), 2 weeks ago) - Argilla is a collaboration platform for AI engineers and domain experts that require high-quality outputs, full data ownership, and overall efficiency.
