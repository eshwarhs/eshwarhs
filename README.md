...
- [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) ([v2.32.2](https://github.com/ToolJet/ToolJet/releases/tag/v2.32.2), 4 days ago) - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.9.7](https://github.com/argoproj/argo-cd/releases/tag/v2.9.7), 1 week ago) - Declarative Continuous Deployment for Kubernetes
