...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.11.0-rc1](https://github.com/argoproj/argo-cd/releases/tag/v2.11.0-rc1), 2 days ago) - Declarative Continuous Deployment for Kubernetes
- [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) ([v2.34.2](https://github.com/ToolJet/ToolJet/releases/tag/v2.34.2), 3 days ago) - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
