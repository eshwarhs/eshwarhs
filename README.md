...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.13.3](https://github.com/argoproj/argo-cd/releases/tag/v2.13.3), 3 days ago) - Declarative Continuous Deployment for Kubernetes
