...
- [argilla-io/argilla](https://github.com/argilla-io/argilla) ([v1.28.0](https://github.com/argilla-io/argilla/releases/tag/v1.28.0), 2 days ago) - Argilla is a collaboration platform for AI engineers and domain experts that require high-quality outputs, full data ownership, and overall efficiency.
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.11.0](https://github.com/argoproj/argo-cd/releases/tag/v2.11.0), 4 days ago) - Declarative Continuous Deployment for Kubernetes
