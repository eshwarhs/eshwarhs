...
- [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) ([v2.33.0](https://github.com/ToolJet/ToolJet/releases/tag/v2.33.0), 1 day ago) - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.10.3](https://github.com/argoproj/argo-cd/releases/tag/v2.10.3), 2 days ago) - Declarative Continuous Deployment for Kubernetes
