...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.8.11](https://github.com/argoproj/argo-cd/releases/tag/v2.8.11), 1 day ago) - Declarative Continuous Deployment for Kubernetes
- [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) ([v2.32.2](https://github.com/ToolJet/ToolJet/releases/tag/v2.32.2), 5 days ago) - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
