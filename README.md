...
- [argilla-io/argilla](https://github.com/argilla-io/argilla) ([v2.0.0rc1](https://github.com/argilla-io/argilla/releases/tag/v2.0.0rc1), 2 days ago) - Argilla is a collaboration platform for AI engineers and domain experts that require high-quality outputs, full data ownership, and overall efficiency.
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.12.0-rc1](https://github.com/argoproj/argo-cd/releases/tag/v2.12.0-rc1), 5 days ago) - Declarative Continuous Deployment for Kubernetes
