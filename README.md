...
- [argilla-io/argilla](https://github.com/argilla-io/argilla) ([v1.27.0](https://github.com/argilla-io/argilla/releases/tag/v1.27.0), 5 days ago) - Argilla is a collaboration platform for AI engineers and domain experts that require high-quality outputs, full data ownership, and overall efficiency.
- [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) ([v2.35.4](https://github.com/ToolJet/ToolJet/releases/tag/v2.35.4), 5 days ago) - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
